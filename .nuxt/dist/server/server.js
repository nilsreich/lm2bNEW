...
module.exports = JSON.parse("{\"title\":\"lm2b2\",\"meta\":[{\"hid\":\"charset\",\"charset\":\"utf-8\"},{\"hid\":\"viewport\",\"name\":\"viewport\",\"content\":\"width=device-width, initial-scale=1\"},{\"hid\":\"mobile-web-app-capable\",\"name\":\"mobile-web-app-capable\",\"content\":\"yes\"},{\"hid\":\"apple-mobile-web-app-title\",\"name\":\"apple-mobile-web-app-title\",\"content\":\"lm2b2\"},{\"hid\":\"description\",\"name\":\"description\",\"content\":\"## Setup\"},{\"hid\":\"theme-color\",\"name\":\"theme-color\",\"content\":\"#E24F55\"},{\"hid\":\"og:type\",\"name\":\"og:type\",\"property\":\"og:type\",\"content\":\"website\"},{\"hid\":\"og:title\",\"name\":\"og:title\",\"property\":\"og:title\",\"content\":\"lm2b2\"},{\"hid\":\"og:site_name\",\"name\":\"og:site_name\",\"property\":\"og:site_name\",\"content\":\"lm2b2\"},{\"hid\":\"og:description\",\"name\":\"og:description\",\"property\":\"og:description\",\"content\":\"## Setup\"}],\"link\":[{\"hid\":\"shortcut-icon\",\"rel\":\"shortcut icon\",\"href\":\"/_nuxt/icons/icon_64x64.8f91ea.png\"},{\"hid\":\"apple-touch-icon\",\"rel\":\"apple-touch-icon\",\"href\":\"/_nuxt/icons/icon_512x512.8f91ea.png\",\"sizes\":\"512x512\"},{\"rel\":\"manifest\",\"href\":\"/_nuxt/manifest.f8ebc802.json\",\"hid\":\"manifest\"}],\"htmlAttrs\":{\"lang\":\"en\"}}");
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".nuxt-progress{position:fixed;top:0;left:0;right:0;height:2px;width:0;opacity:1;transition:width .1s,opacity .4s;background-color:#e24f55;z-index:999999}.nuxt-progress.nuxt-progress-notransition{transition:none}.nuxt-progress-failed{background-color:red}", ""]);
// Exports
...
const _030cef3d = () => interopDefault(__webpack_require__.e(/* import() | pages/releases */ 23).then(__webpack_require__.bind(null, 90)));

const _db473784 = () => interopDefault(__webpack_require__.e(/* import() | pages/_ */ 22).then(__webpack_require__.bind(null, 91)));
...
const components = {
  Alert: () => __webpack_require__.e(/* import() | components/alert */ 1).then(__webpack_require__.bind(null, 92)).then(c => c.default || c),
  Badge: () => __webpack_require__.e(/* import() | components/badge */ 6).then(__webpack_require__.bind(null, 78)).then(c => c.default || c),
  CodeBlock: () => __webpack_require__.e(/* import() | components/code-block */ 7).then(__webpack_require__.bind(null, 93)).then(c => c.default || c),
  CodeGroup: () => __webpack_require__.e(/* import() | components/code-group */ 8).then(__webpack_require__.bind(null, 94)).then(c => c.default || c),
  CodeSandbox: () => __webpack_require__.e(/* import() | components/code-sandbox */ 9).then(__webpack_require__.bind(null, 95)).then(c => c.default || c),
  List: () => __webpack_require__.e(/* import() | components/list */ 20).then(__webpack_require__.bind(null, 96)).then(c => c.default || c),
  AppColorSwitcher: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 24)).then(c => c.default || c),
  BuiltWithNuxtDark: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 62)).then(c => c.default || c),
  BuiltWithNuxtLight: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 61)).then(c => c.default || c),
  IconArrowLeft: () => __webpack_require__.e(/* import() | components/icon-arrow-left */ 10).then(__webpack_require__.bind(null, 68)).then(c => c.default || c),
  IconArrowRight: () => __webpack_require__.e(/* import() | components/icon-arrow-right */ 11).then(__webpack_require__.bind(null, 69)).then(c => c.default || c),
  IconBadgeCheck: () => __webpack_require__.e(/* import() | components/icon-badge-check */ 12).then(__webpack_require__.bind(null, 97)).then(c => c.default || c),
  IconCheckCircle: () => __webpack_require__.e(/* import() | components/icon-check-circle */ 13).then(__webpack_require__.bind(null, 98)).then(c => c.default || c),
  IconChevronRight: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55)).then(c => c.default || c),
  IconClipboardCheck: () => __webpack_require__.e(/* import() | components/icon-clipboard-check */ 14).then(__webpack_require__.bind(null, 65)).then(c => c.default || c),
  IconClipboardCopy: () => __webpack_require__.e(/* import() | components/icon-clipboard-copy */ 15).then(__webpack_require__.bind(null, 66)).then(c => c.default || c),
  IconExclamationCircle: () => __webpack_require__.e(/* import() | components/icon-exclamation-circle */ 16).then(__webpack_require__.bind(null, 99)).then(c => c.default || c),
  IconExternalLink: () => __webpack_require__.e(/* import() | components/icon-external-link */ 17).then(__webpack_require__.bind(null, 67)).then(c => c.default || c),
  IconGithub: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 23)).then(c => c.default || c),
  IconInformationCircle: () => __webpack_require__.e(/* import() | components/icon-information-circle */ 18).then(__webpack_require__.bind(null, 100)).then(c => c.default || c),
  IconMenu: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57)).then(c => c.default || c),
  IconMoon: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)).then(c => c.default || c),
  IconSearch: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54)).then(c => c.default || c),
  IconSun: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 59)).then(c => c.default || c),
  IconTranslate: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 58)).then(c => c.default || c),
  IconTwitter: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 22)).then(c => c.default || c),
  IconX: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 56)).then(c => c.default || c),
  IconXCircle: () => __webpack_require__.e(/* import() | components/icon-x-circle */ 19).then(__webpack_require__.bind(null, 101)).then(c => c.default || c),
  AppCopyButton: () => __webpack_require__.e(/* import() | components/app-copy-button */ 2).then(__webpack_require__.bind(null, 75)).then(c => c.default || c),
  AppDropdown: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 51)).then(c => c.default || c),
  AppFooter: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 21)).then(c => c.default || c),
  AppHeader: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 18)).then(c => c.default || c),
  AppLangSwitcher: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 20)).then(c => c.default || c),
  AppNav: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52)).then(c => c.default || c),
  AppPageBottom: () => __webpack_require__.e(/* import() | components/app-page-bottom */ 3).then(__webpack_require__.bind(null, 76)).then(c => c.default || c),
  AppPrevNext: () => __webpack_require__.e(/* import() | components/app-prev-next */ 4).then(__webpack_require__.bind(null, 77)).then(c => c.default || c),
  AppSearch: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 19)).then(c => c.default || c),
  AppSearchAlgolia: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53)).then(c => c.default || c),
  AppToc: () => __webpack_require__.e(/* import() | components/app-toc */ 5).then(__webpack_require__.bind(null, 64)).then(c => c.default || c)
};
...
const lazy = true;
const langDir = "C:\\Users\\Nils\\Documents\\Devel\\lm2bNEW\\lm2b2\\node_modules\\@nuxt\\content-theme-docs\\src\\i18n";
...
const options_localeCodes = ["en"];
const trailingSlash = undefined;
const ASYNC_LOCALES = {
  'en-US.js': () => __webpack_require__.e(/* import() | lang-en-US.js */ 21).then(__webpack_require__.bind(null, 89))
};
...
var external_is_https_ = __webpack_require__(28);
